...
#
shinyUI(navbarPage(
    title = "Movement of matter in plants",
    tabPanel("Introduction", 
        ...
        fluidRow(
            column(12,
                ...
                textInput(inputId = "name", label = '', "Enter email address here before beginning Plant Basics 1.", width = "100%"),
                actionButton(label = "The email address above is correct", inputId = "NameButton"),
                shinyjs::hidden(div(id = "FeedbackNames", 
                            p(class="text-warning", "Email address recorded, please begin Plant Basics 1 using the tabs at the top of the page.")))
                )
            ),
        fluidRow(
