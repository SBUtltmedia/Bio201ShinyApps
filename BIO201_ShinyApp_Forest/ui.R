...
shinyUI(navbarPage(
    ...
    tabPanel("Introduction", 
        ...
        fluidRow(
            column(12,
                tags$h4("Enter NetID"),
                p("Before beginning the activity, make sure that your ", tags$strong("stonybrook.edu"), "NetID has been recorded in the box below."),
                textInput(inputId = "name", label = '', "Enter NetID here before beginning Part 1.", width = "100%"),
                actionButton(label = "The NetID above is correct", inputId = "NameButton"),
                shinyjs::hidden(div(id = "FeedbackNames", 
                            p(class="text-warning", "NetID recorded, please begin with Part 1 using the tabs at the top of the page.")))
            )
        ),
        fluidRow(
        ...
        fluidPage(
            ...
            fluidRow(
                column(12, style='padding-left:5px; padding-right:1px; padding-top:5px; padding-bottom:15px',
                    ...
                    p("If you are having trouble submitting your responses, make sure: 1) your NetID is filled in on the 'Introduction' tab, and 2) you have unchecked 'None selected.'"),
